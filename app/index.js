...
export const directories = [
  `${homedir}/.traaittCASHInterfaceXT`,
  `${homedir}/.traaittCASHInterfaceXT/logs`
];
...
remote.app.setAppUserModelId('wallet.traaittcash');

log.debug(`traaittCASH Interface XT started...`);
